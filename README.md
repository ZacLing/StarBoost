...
| `examples/chinese_notice_task` | A Chinese-language community health notice; paths and filenames remain English while task content is Chinese. | `min_strengths=2`, `initial_min_weaknesses=3`, decrement `1`; useful for multilingual review. | `timeout_seconds=1800`. |
